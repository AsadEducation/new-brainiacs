...
import "./EidSection.css"; // Import CSS for star animation
    ...
    >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 max-w-xl mx-auto relative z-10">
        <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800 dark:text-gray-100">
          Expected Eid Date:{" "}
          <span className="text-green-600 dark:text-green-400">April 1, 2025</span>
        </h3>
        ...
        <button className="mt-6 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition">
          Claim Free Premium
        </button>
      </div>
    </motion.section>
